    ...
    class MouseHook
    {
        ...
        private static int HookProc(int nCode, IntPtr wParam, IntPtr lParam)
        {
            ...
            if (nCode >= 0)
            {
                ...
                Win32Native.Structures.MOUSELLHookStruct mouseHookStruct = (Win32Native.Structures.MOUSELLHookStruct)Marshal.PtrToStructure(lParam, typeof(Win32Native.Structures.MOUSELLHookStruct));

                short mouseDelta = 0;

                if (GlobalMouseWheel != null && wParam_Int32 == Win32Native.NativeContansts.WM_MOUSEWHEEL)
                ...
                else if (GlobalMouseUp != null && (wParam_Int32 == Win32Native.NativeContansts.WM_LBUTTONUP || wParam_Int32 == Win32Native.NativeContansts.WM_RBUTTONUP || wParam_Int32 == Win32Native.NativeContansts.WM_MBUTTONUP))
                {
                ...
                else if (GlobalMouseDown != null && (wParam_Int32 == Win32Native.NativeContansts.WM_LBUTTONDOWN || wParam_Int32 == Win32Native.NativeContansts.WM_RBUTTONDOWN || wParam_Int32 == Win32Native.NativeContansts.WM_MBUTTONDOWN))
                {
        ...
        private static MouseButtons m_LastClickedButton;
        ...
        private static void DoubleClickTimeElapsed(object sender, EventArgs e)
        {
            ...
            m_LastClickedButton = MouseButtons.None;
        }
        ...
        public class MouseEventArgs : EventArgs
        {
            ...
            internal MouseEventArgs(int wParam, int x, int y, int delta)
            {
                ...
                switch (wParam)
                {
                    case (int)Win32Native.NativeContansts.WM_LBUTTONDOWN:
                    case (int)Win32Native.NativeContansts.WM_LBUTTONUP:
                        Button = MouseButtons.Left;
                        break;
                    case (int)Win32Native.NativeContansts.WM_RBUTTONDOWN:
                    case (int)Win32Native.NativeContansts.WM_RBUTTONUP:
                        Button = MouseButtons.Right;
                        break;
                    case (int)Win32Native.NativeContansts.WM_MBUTTONDOWN:
                    case (int)Win32Native.NativeContansts.WM_MBUTTONUP:
